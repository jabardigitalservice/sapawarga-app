...
class BroadcastCest
{
    ...
    public function getBroadcastStaffKabkotaList(ApiTester $I)
    {
        ...
        $I->sendGET('/v1/broadcasts?kec_id=431');
        ...
        $I->sendGET('/v1/broadcasts?kec_id=432');
        $I->seeHttpHeader('X-Pagination-Total-Count', 0);

        $I->sendGET('/v1/broadcasts?kec_id=431&kel_id=6093');
        ...
        $I->sendGET('/v1/broadcasts?kec_id=431&kel_id=6094');
        $I->seeHttpHeader('X-Pagination-Total-Count', 0);
    }
