...
class m200120_014356_add_action_columns_to_broadcasts_user_messages_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn('broadcasts', 'internal_object', $this->string()->null()->after('link_url'));
        $this->addColumn('broadcasts', 'internal_object_id', $this->integer()->null()->after('internal_object'));
        ...
        $this->addColumn('user_messages', 'internal_object', $this->string()->null()->after('link_url'));
        $this->addColumn('user_messages', 'internal_object_id', $this->integer()->null()->after('internal_object'));
    ...
    public function safeDown()
    {
        ...
        $this->dropColumn('user_messages', 'internal_object');
        ...
        $this->dropColumn('broadcasts', 'internal_object');
